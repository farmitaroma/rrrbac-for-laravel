<nav class="flex flex-1 flex-col">
    <ul role="list" class="flex flex-1 flex-col gap-y-7">
        <li>
            <ul role="list" class="-mx-2 space-y-1 mt-6">
                @include('rrrbac::menu.nav-item', [
                    'label' => 'Roles',
                    'route' => route('rbac.roles.index'),
                ...
                @include('rrrbac::menu.nav-item', [
                    'label' => 'Permissions',
                    'route' => route('rbac.permissions.index'),
